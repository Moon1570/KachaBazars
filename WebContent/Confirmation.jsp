...
<script type="text/javascript">
	...
	function loadUnions(str) {
		...
		xhttp.open("GET", "./dropdown?upazillasId=" + str + "&action=unions",
				true);
		xhttp.send();
		//alert("Hello...")
...
<body>
	...
	<div class="detail-container">
		<div class="current-info">
			...
			<form
				action="./orders?action=usecurrentinfo&cid=${customers.customerId}&pid=${product.productId}&qty=${qty}"
				method="post">
				<p>
					<u>Expected Date</u>
				</p>
				...
				<button class="button red medium">Order</button>
			</form>
		</div>
		...
		<div class="new-info">
			...
			<form
				action="./orders?action=confirm&cid=${customers.customerId}&pid=${product.productId}&qty=${qty}"
				method="post">
				...
				<p>
					<select class="input-field" name="deliveryDivision"
						required="required" id="divisionsDropDown"
				...
				<p>
					<select class="input-field" name="deliveryDistrict"
						required="required" id="districtsDropDown"
						onchange="loadUpazillas(this.value)">

					</select>
				<p>
					<select class="input-field" name="deliveryUpazilla"
						required="required" id="upazillasDropDown"
						onchange="loadUnions(this.value)">

					</select>
				<p>
					<select class="input-field" name="deliveryUnion"
						required="required" id="unionsDropDown">
				...
				<p>
					<input class="input-field" type="date" name="deliveryDate" required="required"
						placeholder="Expected Date">
				</p>

				<p>
					<button class="button blue medium">Order</button>
				</p>
