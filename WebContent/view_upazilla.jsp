	...
	<div class="container float-right mt-5"
		...
		<div class="table-responsive my-5">
			<form class="form-inline" method="post"
				action="./areas?action=addupa" id="form">
				<div class="form-group mx-sm-3 mb-2">
					<label for="exampleInputEmail1">
						<h4>Add Upazilla</h4> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					</label>
					<div class="form-group row">
						...
						<div class="col-xs-2 ml-5">
							<select name="disdd" class="form-control" required="required" id="districtsDropDown">
							<option>Select division first</option>
								
							</select>
						</div>
						<div class="col-xs-2 ml-5">
							<input type="text" class="form-control" name="upaName" required="Hell yeah"
		...
		<div class="text-center">
			<h2 class="d-inline">Upazilla List</h2>
			<hr
		...
		<div class="table-responsive">
			<table id="myTable"
				...
				<thead class="thead-dark">
					<tr>
						<th scope="col">Upazilla ID</th>
						<th scope="col">Upazilla Name</th>
						<th scope="col">District ID & Name</th>
												...
												columns : [
														...
														},
														{
															...
															"mRender" : function(
																	data, type,
																	full) {
																return '<a class="btn btn-outline-info btn-md" href=./areas?action=updateUpa&upaId='
																		+ data.id
																		+ '>'
																		+ 'Edit'
																		+ '</a>   <a class="btn btn-outline-danger btn-md" href=./areas?action=deleteUpa&upaId='
																		+ data.id
																		+ '>'
																		+ 'Delete'
																		+ '</a>';
