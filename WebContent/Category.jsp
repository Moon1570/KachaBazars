	...
	%>
		...
		<c:forEach items="${categories}" var="category">
			<tr>
				...
				<td>
					<a onclick="return confirm('Are you sure you want to delete this item?');" class="red-button small" href="/ecommerce/categories?action=delete&id=${category.categoryId}">Delete</a>
				</td>
			</tr>
		</c:forEach>
