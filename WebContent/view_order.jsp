		...
		<form action="./orderoperations?soid=${order.orderId}&action=editordersellerproduct" method="post">
			...
			<table>
				...
				<tr>
					...
					<td>
						<select name="deliveryDivision" required="required" id="divisionsDropDown" onchange="loadDistricts(this.value)">
								<option value="${order.divisionModel.divisionId}">${order.divisionModel.divisionBanglaName}</option>
				...
				<tr>
					...
					<td>
						<select name="deliveryDistrict" required="required" id="districtsDropDown" onchange="loadUpazillas(this.value)">
				...
				<tr>
					...
					<input type="hidden" name="productModel" value="${order.sellersProduct.productId}">
