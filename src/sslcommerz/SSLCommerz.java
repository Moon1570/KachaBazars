...
import Utility.Util;
import parametermappings.SSLCommerzInitResponse;
import parametermappings.SSLCommerzValidatorResponse;
...
public class SSLCommerz {
    ...
    boolean orderValidate(String merchantTrnxnId, String merchantTrnxnAmount, String merchantTrnxnCurrency,
        ...
        if (hash_verified) {
          ...
          //      if (resp.getStatus().equalsIgnoreCase("VALID") || resp.getStatus().equals("VALIDATED")) 
                {
